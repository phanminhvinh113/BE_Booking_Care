...
router.get(
  "/api/get-list-patient-booking-medical",
  doctorController.getListPatientBooingMedical
);
...
router.post(
  "/api/complete-confirm-medical",
  doctorController.completeConfirmMedical
);
router.get("/api/feedback-doctor", doctorController.getFeedbackDoctor);

//    PATIENT      ///
router.post(
  "/api/post-info-booking-medical",
  patientController.postInfoBookingMedical
);
router.post(
  "/api/post-info-booking-medical",
  patientController.postInfoBookingMedical
...
router.post(
  "/api/verify-booking-patient",
  patientController.verifyBookingPatient
);
...
router.get(
  "/api/get-top-specialty",
  getDataRedis,
  specialtyController.getTopSpecialty
);
router.get("/api/get-all-specialty", specialtyController.getAllSpecialty);
router.post(
  "/api/post-or-save-info-specialty",
  specialtyController.postInfoSpecialty
);
router.get("/api/get-specialty-by-id", specialtyController.getSpecialtyById);
router.get(
  "/api/get-info-doctor-belong-specialty-by-province",
  specialtyController.getInfoDoctorBelongSpecialty
);
...
router.get(
  ...
  getDataRedis,
  clinicController.getTopClinicHome
);
